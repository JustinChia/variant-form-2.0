	...
	<Layout class="full-height">
		<Header class="main-header">
			<div class="float-left main-title">
				...
				<span class="bold">VariantForm Pro</span> {{i18nt('application.productTitle')}} <span
					class="version-span">Ver {{vFormVersion}}</span>
			</div>
			<div class="float-right external-link">
				...
				<a href="javascript:void(0)" @click="(ev) => openUrl(ev, gitUrl)" target="_blank">
					<svg-icon icon-class="github" />{{i18nt('application.github')}}
				</a>
				<a href="javascript:void(0)" @click="(ev) => openUrl(ev, docUrl)" target="_blank">
					<svg-icon icon-class="document" />{{i18nt('application.document')}}
				</a>
				<a href="javascript:void(0)" @click="(ev) => openUrl(ev, chatUrl)"
...
<script>
	...
	import {
		createDesigner
	} from "@/components-iview/form-designer/designer";
	import {
	...
	import i18n, {
		changeLocale
	} from "@/components-iview/utils/i18n";
